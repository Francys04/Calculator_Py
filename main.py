...
def equals():
    ...
    try:
        #set zero division to exception
...
equall = Button(frame, text='=', height=4, width=9, font=35, command=equals)
equall.grid(row=0, column=4)

decimal = Button(frame, text='.', height=4, width=9, font=35, command=lambda: button_press('.'))
decimal.grid(row=1, column=4)

clear = Button(window, text='C', height=4, width=39, font=35, command=clear)
clear.pack()
